      ...
      <div className="w-[100%] h-[100vh] flex justify-center items-center">
        <div className="w-[80%] h-[87vh] items-center shadow-2xl rounded-[7px] border-[1px] border-[#ffff] flex-wrap flex">
          <form
            ...
            className="w-[57%] h-[87vh] flex justify-center items-center flex-col flex-wrap gap-[20px]"
          >
            ...
            <nav className="w-[50%] min-h-[10px] border-[2px] border-[blue] relative rounded-[4px] hover:border-[green]">
              <span className="bg-[#fff] flex justify-center items-center mt-[-15px] absolute ml-3 text-center ">
                Email
              </span>
              <input
                type="text"
                placeholder="Email"
                className="mt-[20px] h-[35px] w-[100%] px-2 outline-none text-[#000]"
                {...register("email")}
              />
            </nav>
            <nav className="w-[50%] min-h-[10px] border-[2px] border-[blue] relative rounded-[4px] hover:border-[green]">
              <span className="bg-[#fff] mt-[-15px] absolute ml-3 text-center">
                Password
              </span>
              <input
                type="password"
            ...
            <div className="w-[50%] flex-wrap flex max-sm:w-screen max-sm:text-[10px]">
              <input
                type="checkbox"
                name=""
                id=""
            ...
            <button
              className={`py-[7px] px-[50px] justify-center items-center flex
${checked ? "bg-[blue]" : "bg-gray-400"} text-[#FFF] rounded-[7px]`}
          ...
          <img
            src={tech}
            alt=""
            className="w-[42%] h-[85vh] object-cover flex items-center justify-center rounded-[5px]"
          />
        </div>
      </div>
    </div>
